...
# used to merge dictionary for task 1-2
def sum_dict(a, b):
    temp = dict()
...
# used to merge dictionary for task3
...
# The total size divided by the number of processes will get the number of bytes that each process is responsible for
...
with open('./twitter-data-small.json', 'r', encoding='utf-8') as tweets_file:
    ...
    if rank == 0:
        ...
        # merge dict, resolve author id duplicates in the different file segments
        # which are processed by different processes
